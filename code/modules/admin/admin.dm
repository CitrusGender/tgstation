...
/datum/admins/proc/show_lag_switch_panel()
	...
	dat += "Disable runechat (except ELEVATED trait): <a href='?_src_=holder;[HrefToken()];change_lag_switch=[DISABLE_RUNECHAT]'><b>[SSlag_switch.measures[DISABLE_RUNECHAT] ? "On" : "Off"]</b></a><br/>"
	dat += "</body></html>"
	usr << browse(dat.Join(), "window=lag_switch_panel;size=420x300")
